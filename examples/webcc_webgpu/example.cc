...
void update(float time_ms) {
        ...
        switch (opcode) {
            case webcc::wgpu::EVENT_ADAPTER_READY: {
                ...
                if (handle == 0) {
                    ...
                    int msg = webcc::dom::create_element("div");
            ...
            case webcc::wgpu::EVENT_DEVICE_READY: {
                ...
                int shader_module = webcc::wgpu::create_shader_module(device, shader_code);
    ...
    int encoder = webcc::wgpu::create_command_encoder(device);
    int view = webcc::wgpu::get_current_texture_view(wgpu_ctx);
    
    // Clear to dark blue
    int pass = webcc::wgpu::begin_render_pass(encoder, view, 0.0f, 0.0f, 0.2f, 1.0f);
    ...
    int cmd_buffer = webcc::wgpu::finish_encoder(encoder);
...
int main() {
    ...
    int canvas = webcc::canvas::create_canvas("wgpu-canvas", 600, 600);
